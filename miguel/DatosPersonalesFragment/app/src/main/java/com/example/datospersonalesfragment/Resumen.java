...
public class Resumen extends AppCompatActivity {
    ...
    String nombre, apellido,ciudad,pais,edad,size;
    ...
    protected void onResume() {
        ...
        //Consulta tamaño de texto

        SharedPreferences preferencia_size_text=getSharedPreferences(Constantes.NOMBRE_PREFERENCIA_2,MODE_PRIVATE);
        size=preferencia_size_text.getString(Constantes.SIZE,"2");
        Log.i("size", size);
        switch (size){
            case "1":txtNombre.setTextSize(10);
                    txtLugar.setTextSize(10);
                    break;

            case "2":txtNombre.setTextSize(30);
                    txtLugar.setTextSize(30);
                     break;
            case "3":txtNombre.setTextSize(50);
                    txtLugar.setTextSize(50);
                    break;
        }
